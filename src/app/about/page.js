...
//             <h1 className='text-[0.8px] font-bold font-InstrumentSans text-[#D64830] leading-[119%] tracking-[2px] max-[1280px]:px-[25px]'>OUR MISSION</h1>
...
//           <h1 className='text-[0.8rem] font-bold font-InstrumentSans text-[#D64830] leading-[119%] tracking-[2px]'>OUR VALUES</h1>
...
export default function AboutUs() {
  ...
  return (
    <main className="flex flex-col justify-center items-center w-full bg-[#ffffff] gap-y-[60px]">
      ...
      {/* Our Mission */}
      <section className='flex justify-start items-start w-full min-h-[60vh]' aria-labelledby="mission-heading">
        <div className='flex justify-start items-start h-full w-full bg-[#ffffff] max-[1280px]:flex-col min-[1280px]:pl-[77px]'>
          <div className='w-[40%] max-[1280px]:w-full flex flex-col justify-start items-start gap-y-[14px] min-[1280px]:pt-[70px] max-[1280px]:py-[25px]'>
            <h2 id="mission-heading" className='text-[0.8px] font-bold font-InstrumentSans text-[#D64830] leading-[119%] tracking-[2px] max-[1280px]:px-[25px]'>OUR MISSION</h2>
            ...
            <article className='bg-[#f6c26e] pt-[40px] pl-[32px] pb-[45px] pr-[59px] mt-[66px] max-[825px]:mt-[40px]'>
              <p className='text-[#755A2D] text-[14px] font-InstrumentSans leading-[150%]'>In two years, AppStorys aims to be a leader in app engagement and retention, powering thousands of apps worldwide. We envision expanding our SDK to include AI-driven personalization and advanced analytics, partnering with top-tier developers to enhance user interaction and growth. With a stronger global presence and cutting-edge technology, we plan to double our client base and become the go-to platform for improving app experiences.</p>
            </article>
          </div>
          <div className='h-full flex justify-center items-center max-[1280px]:w-full'>
      ...
      {/* Our Values */}
      <section className='bg-[#d7e5ff] min-h-[577px] w-full flex justify-center items-center py-[90px] max-[1078px]:py-[50px] max-[1078px]:flex-col max-[1078px]:gap-y-[30px]' aria-labelledby="values-heading">
        <div className='w-[55%] max-[1078px]:w-full flex flex-col justify-start items-start gap-y-[9px] min-[1356px]:pl-[155px] px-[60px] max-[435px]:px-[25px]'>
          <h2 id="values-heading" className='text-[0.8rem] font-bold font-InstrumentSans text-[#D64830] leading-[119%] tracking-[2px]'>OUR VALUES</h2>
      ...
      {/* Our Offices */}
      <section className='flex justify-between items-start w-full bg-[#1f4d9c] min-h-[60vh] relative overflow-hidden max-[1220px]:flex-col max-[1220px]:h-auto max-[1220px]:gap-y-[20px]' aria-labelledby="offices-heading">
        <div className='w-[30%] max-[1381px]:w-[50%] flex flex-col min-[1220px]:pl-[117px] max-[1381px]:pl-[50px] justify-start items-start h-full pt-[75.64px] gap-y-[30.36px] z-[1000] max-[1220px]:w-full max-[1220px]:px-[25px]'>
          <h2 id="offices-heading" className='text-[54px] font-semibold font-InstrumentSans text-[#fff] leading-[127%] -tracking-[0.5px]'>Our Global Offices</h2>
          <p className='text-white text-[16px] leading-[130%]'>We are a global leader in app engagement and retention, with diverse teams delivering innovative solutions worldwide. Our expertise in SDK integration empowers app developers to unlock growth and enhance user experiences.</p>
        </div>
        <Image
          src={officesImage}
      ...
      {/* One More Thing */}
      <section className='flex w-full flex-col justify-center items-center gap-y-[20px] px-[307px] py-[64.5px] bg-[#d7e5ff] max-[1208px]:px-[150px] max-[960px]:px-[100px] max-[960px]:gap-y-[20px] max-[651px]:px-[50px] max-[454px]:px-[25px] max-[454px]:py-[25px]' aria-labelledby="closing-heading">
