...
//   return (
//     <main className="flex flex-col justify-center items-center w-full bg-[#fafafa]">
...
//           <h1 className='text-[64px] font-sans font-semibold leading-[120%] tracking-[-0.5px] max-[644px]:text-[50px] capitalize max-[519px]:text-[40px]'>Explore our insights</h1>
//           <p className='text-[#545454] text-[16px] font-sans leading-[150%] min-[898px]:w-[554px]'>Discover expert tips, trends, and insights to stay ahead in the ever-evolving industry. Explore our curated content for fresh ideas and practical advice that inspire growth and innovation.</p>
//         </div>
//       </section>
...
//         <div className="relative min-[1078px]:w-[780px] max-[1282px]:w-[680px] h-[300px] sm:h-[350px] md:h-[400px]">
//           <Image
//             src={blogAppRetentionMain}
//             alt="AppStorys Blog App Retention main"
//             layout="fill"
//             objectFit="contain"
//             priority
//           />
...
//           <h1 className='uppercase text-[#d64830] font-sans text-[12px] font-bold'>Featured</h1>
//           <p className='capitalize text-[#1F4D9C] text-[30px] min-[1282px]:w-[351px] leading-[111%] font-semibold font-sans mt-[4px]'>5 Ways to Increase App Retention</p>
//           <p className="uppercase text-[#A8A8A8] font-semibold font-sans text-[10px] w-full flex justify-start items-center leading-[150%] tracking-[2px] gap-x-[6px] mt-[24px]">
...
//           </p>
//           <p className='font-sans text-[14px] leading-[150%] text-[#657BA0] min-[1282px]:w-[361px]'>In today's competitive mobile app landscape, retaining users is as crucial as acquiring them ...</p>
//           <Link href='/blogs/5-Ways-to-Increase-App-Retention' className='underline hover:cursor-pointer underline-offset-4 text-[#1F4D9C] font-sans text-[14px] mt-[58px] max-[966px]:mt-[30px] max-[537px]:mt-[20px]'>Read More</Link>
//         </div>
//       </section>
...
//           <p className='font-sans tracking-[1.73px] font-bold text-[12px] flex gap-x-[9px] justify-center items-center hover:cursor-pointer uppercase'>
