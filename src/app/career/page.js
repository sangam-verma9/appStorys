...
export default function CareerPage() {
    ...
    return (
        <div className='flex justify-center w-full'>
            <main className="flex flex-col justify-center items-center w-full bg-[#fff] max-[927px]:py-[0px] gap-y-[60px] max-w-[1350px]">
                {/* Layer */}
                <section className='flex justify-start items-start min-[1078px]:min-h-[70vh] w-full max-[1078px]:flex-col'>
                    <div className='w-[40%] bg-[#ffffff] h-[100%] flex flex-col justify-start items-start py-[25px] px-[25px] max-[371px]:px-[15px] gap-y-[20px] max-[1327px]:w-[50%] max-[1078px]:w-full'>
                        ...
                        <div className='flex flex-col justify-center items-center w-[100%]'>
                            <form onSubmit={handleSubmit} className='w-[100%] flex flex-col justify-center items-center py-[30px] bg-[#FFF7F3] px-[34px] max-[426px]:px-[25px] gap-y-[20px]'>
                                <div className='w-full justify-between items-start flex flex-col gap-y-[16px] max-[424px]:gap-y-[12px] font-InstrumentSans text-black'>
                                    <label htmlFor="area of interest" className='text-[#fd5f03] leading-[150%] text-[16px] capitalize font-InstrumentSans'>Select your area of interest &nbsp;<span className='text-[#D64830]'>*</span></label>
                                    <div className='relative w-full'>
                                        <div
                                            className='py-[14px] pl-[16px] w-full font-InstrumentSans text-black bg-white flex justify-between items-center cursor-pointer'
                                ...
                                <div className='flex justify-between items-center w-full gap-x-[31px] max-[607px]:flex-col max-[607px]:gap-y-[20px]'>
                                    <div className='w-full justify-between items-start flex flex-col gap-y-[16px] max-[424px]:gap-y-[12px]'>
                                        <label htmlFor="Full Name" className='text-[#fd5f03] leading-[150%] text-[16px] capitalize font-InstrumentSans'>Full Name&nbsp;<span className='text-[#D64830]'>*</span></label>
                                        <input
                                            type="text"
                                            name='Full Name'
                                            value={fullName}
                                            className='py-[14px] pl-[16px] w-full font-InstrumentSans text-black placeholder-black bg-white'
                                            placeholder='Please enter first name'
                                            onChange={(e) => { setFullName(e.target.value) }}
                                        />
                                    </div>
                                    <div className='w-full justify-between items-start flex flex-col gap-y-[16px] max-[424px]:gap-y-[12px]'>
                                        <label htmlFor="Email" className='text-[#fd5f03] leading-[150%] text-[16px] capitalize font-InstrumentSans'>Email&nbsp;<span className='text-[#D64830]'>*</span></label>
                                        <input
                                            type="email"
                                            name='Email'
                                            value={email}
                                ...
                                <div className='w-full justify-between items-start flex flex-col gap-y-[16px] max-[424px]:gap-y-[12px] mt-[9px]'>
                                    <label htmlFor="Phone Number" className='text-black leading-[150%] text-[16px] capitalize font-InstrumentSans'>Phone Number &nbsp;<span className='text-[#D64830]'>*</span></label>
                                    <input
                                        type="tel"
                                        name='Phone Number'
                                        value={phoneNumber}
                                ...
                                <div className='w-full justify-between items-start flex flex-col gap-y-[16px] max-[424px]:gap-y-[12px] mt-[9px] font-InstrumentSans'>
                                    <label htmlFor="Preferred location" className='text-[#fd5f03] leading-[150%] text-[16px] capitalize font-InstrumentSans'>Preferred location&nbsp;<span className='text-[#D64830]'>*</span></label>
                                    <div className='relative w-full'>
                                        <div
                                            className='py-[14px] pl-[16px] w-full font-InstrumentSans text-black bg-white flex justify-between items-center cursor-pointer'
                                ...
                                <button className='flex cursor-pointer justify-center items-center py-[11px] px-[50px] gap-x-[8px] bg-[#fd5f03] text-white rounded-[25px] mt-[25px] text-[10px] font-semibold font-InstrumentSans tracking-[1px]' type='submit'>
                            ...
                            </form>
                            {
                                ...
                                <div className='max-[694px]:px-[25px] w-full h-full flex justify-center items-center bg-[#d9d9d9af] z-[100000] fixed top-0 left-0 '>
                                    <div className='bg-white w-[60%] min-[1046px]:h-[278px] gap-y-[32px] flex justify-center items-center flex-col min-[1046px]:px-[126px] max-[1046px]:px-[20px] max-[1046px]:py-[40px] max-[694px]:w-full'>
                                        ...
                                        <Link href='/home' onClick={() => { setSubmitSuccess(false) }} className='h-[34px] w-[133px] bg-[#fd5f03] flex justify-center items-center gap-x-[9px] text-white tracking-[1px] text-[10px] font-semibold font-InstrumentSans'>
                    ...
                    <div className='w-[60%] bg-[#fd5f03] h-[100%] flex justify-start items-start px-[25px] py-[25px] max-[1327px]:w-[50%] max-[1078px]:w-full'>
                ...
                {/* Location Setion */}
                <section className='bg-[#fff] flex flex-col justify-center items-center py-[67px] px-[20px] max-[540px]:px-[25px] max-[540px]:py-[25px] w-full gap-y-[15.89px]'>
