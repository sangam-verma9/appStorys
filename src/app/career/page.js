...
//                 {/* <div className="flex justify-center items-center h-full relative w-full bg-white" > */}
...
//                                 <Box sx={{ width: '100%', background: '#fff', border: 'none', color: '#B8B8B8' }} >
//                                     <FormControl fullWidth sx={{ border: 'none' }}>
//                                         <InputLabel sx={{ color: '#B8B8B8' }} id="demo-simple-select-label">Interest</InputLabel>
//                                         <Select
...
//                                             }}
//                                         >
//                                             <MenuItem value='Django Developer' sx={{ textAlign: 'start' }}>Django Developer</MenuItem>
//                                             <MenuItem value='SDE Manager' sx={{ textAlign: 'start' }}>SDE Manager</MenuItem>
//                                             <MenuItem value='DevOps Engineer' sx={{ textAlign: 'start' }}>DevOps Engineer</MenuItem>
//                                             <MenuItem value='Graphic Designer' sx={{ textAlign: 'start' }}>Graphic Designer</MenuItem>
//                                             <MenuItem value='Typescript Developer' sx={{ textAlign: 'start' }}>Typescript Developer</MenuItem>
//                                         </Select>
//                                     </FormControl>
//                                 </Box>
//                             </div>
...
//                                         <InputLabel sx={{ color: '#B8B8B8' }} id="Location">Location</InputLabel>
//                                         <Select
//                                             labelId="Location"
//                                             id="Location"
//                                             value={location}
...
//                                                 Mumbai
//                                             </MenuItem>
//                                             <MenuItem value="Navi Mumbai">
//                                                 Navi Mumbai
//                                             </MenuItem>
//                                             <MenuItem value="Fremont - California">
//                                                 Fremont - California
//                                             </MenuItem>
...
//                 </div>
//                 {/* </div> */}
//                 {/* <div className='w-full flex justify-center items-center h-full pt-[140px]'> */}
