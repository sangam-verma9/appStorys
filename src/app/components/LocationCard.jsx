...
const LocationCard = ({ country, city, address }) => {
  return (
    <div className='w-[300px] max-[1440px]:w-[450px] h-[230px] bg-[#FFF7F3] flex flex-col justify-start items-start border-l-[5.87px] border-[#fd5f03] py-[34.11px] px-[31.03px] gap-y-[12.09px]'>
