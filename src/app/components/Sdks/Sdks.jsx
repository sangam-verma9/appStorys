...
//           <h3 className={`${satisfy.className} text-[#FD5F03] text-[26px] mb-4 capitalize`}
//               style={{
//                 letterSpacing: '1px',
//                 lineHeight: '27.6px'
//               }}>
//             How It Works
//           </h3>
//           <h1 className="text-white text-[56px] font-[500] leading-[102%] capitalize"
//              >
//             Enterprise Ready SDKs
//           </h1>
//           <p className="text-white text-[16px] max-w-[800px] mx-auto mt-4"
//              style={{
//                lineHeight: '128%',
