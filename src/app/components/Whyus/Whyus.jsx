...
const Whyus = () => {
    ...
    return (
        <div className='w-full bg-[#EDF7FF]'>
            <div className='sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] px-10 py-5  flex flex-col justify-center mx-auto'>
                ...
                <div className='mx-auto '>
                    <div className='grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 justify-center'>
                        <div className='h-[490px] w-[365px] bg-white px-7 py-10 rounded-3xl border border-[#DEDFE3] shadow-[2px_4px_38px_0px_rgba(0,0,0,0.07)] scale-[0.9]'>
                        ...
                        <div className='h-[490px] w-[365px] bg-white px-7 py-10 rounded-3xl border border-[#DEDFE3] shadow-[2px_4px_38px_0px_rgba(0,0,0,0.07)] scale-[0.9]'>
                            <h3 className={`${bricolageGrotesque.className} card-whyus-heading text-[22px] capitalize mb-2`}>Easy Audience segmentation</h3>
                        ...
                        <div className='h-[490px] w-[365px] bg-white px-7 py-10 rounded-3xl border border-[#DEDFE3] shadow-[2px_4px_38px_0px_rgba(0,0,0,0.07)] scale-[0.9] -mt-5'>
                            ...
                            <div className='w-[100%] h-[55%] relative flex justify-center items-center mx-auto'>
                                <img src={quick_intgration_whyus.src} fill alt='security' />
                            </div>
                        ...
                        <div className='h-[490px] w-[365px] bg-white px-7 py-10 rounded-3xl border border-[#DEDFE3] shadow-[2px_4px_38px_0px_rgba(0,0,0,0.07)] scale-[0.9] -mt-5'>
                            ...
                            <div className='w-[100%] h-[53%] relative flex justify-center items-center mx-auto mb-2'>
                                <img src={tailored_whyus.src} fill alt='security' />
                            </div>
                        ...
                        <div className='h-[490px] w-[365px] bg-white px-7 py-10 rounded-3xl border border-[#DEDFE3] shadow-[2px_4px_38px_0px_rgba(0,0,0,0.07)] scale-[0.9] -mt-5'>
                            ...
                            <div className='w-[80%] h-[56%] relative flex justify-center items-center mx-auto'>
                                <img src={powerfull_whyus.src} fill alt='security' />
                            </div>
