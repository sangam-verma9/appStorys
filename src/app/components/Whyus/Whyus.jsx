...
const Whyus = () => {
    ...
    return (
        <div className='px-16 py-5  flex flex-col justify-center bg-[#EDF7FF]'>
            ...
            <div className='grid sm:grid-cols-3 sm:px-20 px-10 grid-cols-1 justify-center'>
                <div className='h-[490px] w-[365px] bg-white px-7 py-10 rounded-3xl border border-[#DEDFE3] cards'>
                ...
                <div className='h-[490px] w-[365px] bg-white px-7 py-10 rounded-3xl border border-[#DEDFE3] cards -mt-5'>
