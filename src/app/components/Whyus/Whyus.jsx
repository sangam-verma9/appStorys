                        ...
                        <div className='h-[450px] w-[380px] scale-[0.9]'>
                            <TiltedCard>
                                <div className="h-full w-full px-7 py-10">
                                    ...
                                    <br />
                                    <p className={`font-sfpro text-[#737373] font-normal text-[16px] card-paragraph mt-1`}>Integrate with your CDP, let events flow and show campaigns accordingly.</p>
                                </div>
                            </TiltedCard>
                        </div>
                        ...
                        <div className='h-[450px] w-[380px] scale-[0.9]'>
                            <TiltedCard>
                                <div className="h-full w-full px-7 py-10">
                                    ...
                                    <br />
                                    <p className={`font-sfpro text-[#737373] font-normal text-[16px] card-paragraph mt-1`}>Data starts flowing in real time once your campaign goes live. View, analyze and make data drive decisions.
                                    </p>
                                </div>
                            </TiltedCard>
                        </div>
                        ...
                        <div className='h-[450px] w-[380px] scale-[0.9] lg:-mt-5'>
                            <TiltedCard>
                                <div className="h-full w-full px-7 py-10">
                                    ...
                                    <br />
                                    <p className={`font-sfpro text-[#737373] font-normal text-[16px] card-paragraph mt-1`}>Integrate our SDK (our team can help), test on a sandbox environment and take campaigns live
                                    </p>
                                </div>
                            </TiltedCard>
                        </div>
                        ...
                        <div className='h-[450px] w-[380px] scale-[0.9] lg:-mt-5'>
                            <TiltedCard>
                                <div className="h-full w-full px-7 py-10">
                                    ...
                                    <br />
                                    <p className={`font-sfpro text-[#737373] font-normal text-[16px] card-paragraph mt-1`}>Show different campaigns to different users based on their attributes and conditions. Powerful segmentation.</p>
                                </div>
                            </TiltedCard>
                        </div>
                        ...
                        <div className='h-[450px] w-[380px] scale-[0.9] lg:-mt-5'>
                            <TiltedCard>
                                <div className="h-full w-full px-7 py-10">
                                    ...
                                    <br />
                                    <p className={`font-sfpro text-[#737373] font-normal text-[16px] card-paragraph mt-1`}>Super fast dashboard to create campaigns with deep controls to customize every style, frequency, condition, cohorts & more.</p>
                                </div>
                            </TiltedCard>
                        </div>
                    </div>
