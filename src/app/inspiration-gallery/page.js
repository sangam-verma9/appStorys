...
const page = () => {
    const mockupImages = [
        '/inspiration/Rectangle_1.png',
        '/inspiration/Rectangle_2.png',
        '/inspiration/Rectangle_3.png',
        '/inspiration/Rectangle_4.png',
        '/inspiration/Rectangle_5.png',
        '/inspiration/Rectangle_6.png',
        '/inspiration/Rectangle_7.png',
        '/inspiration/Rectangle_8.png',
        '/inspiration/Rectangle_9.png',
        '/inspiration/Rectangle_10.png',
        '/inspiration/Rectangle_11.png',
        '/inspiration/Rectangle_12.png',
        '/inspiration/Rectangle_13.png',
    ];
    ...
    const getTextColor = (bgColor) => {
        ...
        const darkBgs = ['#FF4757', '#6C5CE7'];
        return darkBgs.includes(bgColor) ? 'text-white' : 'text-gray-800';
    };

    return (
        <>
            <div className="bg-[#FFF7F3] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col items-center gap-8 lg:gap-16">
                        ...
                        <div className="w-full lg:w-3/5">
                            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
                                ...
                                <div className="transform -rotate-2 hover:rotate-0 transition-transform duration-300 mt-4 sm:mt-8">
                                    <div className="bg-white rounded-2xl p-1 shadow-lg">
                                        <img
                                            src={mockupImages[1]}
                                            alt="Mobile app mockup"
                                ...
                                <div className="transform -rotate-3 hover:rotate-0 transition-transform duration-300 mt-6 sm:mt-12 ">
                                    <div className="bg-white rounded-2xl p-1 shadow-lg">
                                        <img
                                            src={mockupImages[3]}
                                            alt="Mobile app mockup"
                                ...
                                {/* Row 2 */}
                                <div className="transform -rotate-1 hover:rotate-0 transition-transform duration-300 mt-2 sm:mt-4">
                                    <div className="bg-white rounded-2xl p-1 shadow-lg">
                                        <img
                                            src={mockupImages[4]}
                                            alt="Mobile app mockup"
                                ...
                                <div className="transform -rotate-2 hover:rotate-0 transition-transform duration-300 mt-4 sm:mt-6 ">
                                    <div className="bg-white rounded-2xl p-1 shadow-lg">
                                        <img
                                            src={mockupImages[6]}
                                            alt="Mobile app mockup"
                        ...
                        <div className="w-full lg:w-2/5  text-center lg:text-left">
                            <div className="max-w-md mx-auto lg:mx-0">
                                <h4 className={`${satisfy.className} text-orange-500 text-center text-xl sm:text-2xl font-normal mb-3 sm:mb-4`}>
                                    Inspiration Gallery
                                </h4>
                                <h2 className="text-3xl sm:text-4xl text-center lg:text-5xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
                                    Real-World Success Stories
                                </h2>
                                <p className="text-gray-600 text-center text-base sm:text-lg leading-relaxed">
                                    Learn how innovative tech companies are using in-app experiences to enhance activation, user engagement, and revenue growth.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full justify-center flex flex-col max-w-[1200px]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredCards.map((card, index) => (
                                <div
                                    key={index}
                                    className="rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 h-[450px] "
                                ...
                                >
                                    <div className="flex items-center justify-between mb-6">
                                        ...
                                        <div className="w-20 h-36 bg-gray-800 rounded-2xl p-1 flex-shrink-0 overflow-hidden ">
